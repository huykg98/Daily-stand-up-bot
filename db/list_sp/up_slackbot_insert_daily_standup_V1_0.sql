...
DELIMITER //
DROP PROCEDURE IF EXISTS up_slackbot_insert_daily_standup_V1_0//
CREATE PROCEDURE `up_slackbot_insert_daily_standup_V1_0`( pTitle varchar(255), pQuestionTemplateName varchar(255), pRemindTime varchar(255), pPeriod varchar(255), pDayOfWeek varchar(255), pRemindMessage varchar(255))
BEGIN
    ...
    INSERT INTO `slackbot_dailyreport_dialog_form` (`template_id`, `title`, `state`, `date_created`, `schedule_id`)
 	VALUES (v_template_id, pTitle, "true", now(), v_schedule_id);
